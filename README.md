...
In essence, ZarpBytes serves a similar purpose to Java's non-blocking I/O ByteBuffer (Java NIO). The API offers:
...
| Operation                  | Index/Streaming | Binary                                                                            |
|:---------------------------|:----------------|:----------------------------------------------------------------------------------|
...
| Operation             | Explain                                                              |
|:----------------------|:---------------------------------------------------------------------|
| read/write primitives | read and write of primitive data structures stored in binary form    |
...
A Bytes buffer have the following properties:
...
![Buffer figure](./docs/images/ZarpBytes-figure.jpg)

### Understand BytesStore
