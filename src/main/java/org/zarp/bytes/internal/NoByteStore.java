...
public final class NoByteStore implements ZByteStore<Void> {
    ...
    @Override
    public void write(long offset, byte[] src, int srcBegin, int len) throws IllegalStateException, DecoratedBufferOverflowException {

    }

    @Override
    public void write(long offset, ByteBuffer src, int srcBegin, int len) throws IllegalStateException, DecoratedBufferOverflowException {
